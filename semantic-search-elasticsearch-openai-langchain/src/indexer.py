...
def main():
    ...
    # Assuming you have a list of texts and corresponding metadata
    ...
    # embedding = OpenAIEmbeddings(openai_api_key="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")
